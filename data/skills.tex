...
%---------------------------------------------------------
  \cvdesch
    {DevOps} % Category
    {CI/CD with Jenkins pipelines on Groovy, Container- ization with Docker and ECR, Orchestration on Docker Swarm, Compose and Kubernetes, EKS, IAC using CloudFormation and Ansible, Ant, ELK Stack, Prometheus/Grafana, Nagios.} % Skills
